        ...
        [
            ...
            (
                ...
                **없다면 없다고 말하십시오.**
                ...
                2. rofan_tool에 search_web을 이용해서 알아낸 **전체 이름**을 검색해서 **이 작품의 키워드**를 반드시 알아냅니다.
                3. rofan_tool에 벡터스토어 검색으로 알아낸 **이 작품의 키워드**를 반드시 **검색어**로 넣어 이 작품의 키워드와 **비슷한 작품**을 찾으십시오.
